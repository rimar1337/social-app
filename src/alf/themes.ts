...
export function createThemes({
  ...
  const color = {
    ...
    green_25: changeHue(`hsl(${hues.positive}, 82%, 97%)`),
    green_50: changeHue(`hsl(${hues.positive}, 82%, 95%)`),
    green_100: changeHue(`hsl(${hues.positive}, 82%, 90%)`),
    green_200: changeHue(`hsl(${hues.positive}, 82%, 80%)`),
    green_300: changeHue(`hsl(${hues.positive}, 82%, 70%)`),
    green_400: changeHue(`hsl(${hues.positive}, 82%, 60%)`),
    green_500: changeHue(`hsl(${hues.positive}, 82%, 50%)`),
    green_600: changeHue(`hsl(${hues.positive}, 82%, 42%)`),
    green_700: changeHue(`hsl(${hues.positive}, 82%, 34%)`),
    green_800: changeHue(`hsl(${hues.positive}, 82%, 26%)`),
    green_900: changeHue(`hsl(${hues.positive}, 82%, 18%)`),
    green_950: changeHue(`hsl(${hues.positive}, 82%, 10%)`),
    green_975: changeHue(`hsl(${hues.positive}, 82%, 7%)`),

    red_25: changeHue(`hsl(${hues.negative}, 91%, 97%)`),
    red_50: changeHue(`hsl(${hues.negative}, 91%, 95%)`),
    red_100: changeHue(`hsl(${hues.negative}, 91%, 90%)`),
    red_200: changeHue(`hsl(${hues.negative}, 91%, 80%)`),
    red_300: changeHue(`hsl(${hues.negative}, 91%, 70%)`),
    red_400: changeHue(`hsl(${hues.negative}, 91%, 60%)`),
    red_500: changeHue(`hsl(${hues.negative}, 91%, 50%)`),
    red_600: changeHue(`hsl(${hues.negative}, 91%, 42%)`),
    red_700: changeHue(`hsl(${hues.negative}, 91%, 34%)`),
    red_800: changeHue(`hsl(${hues.negative}, 91%, 26%)`),
    red_900: changeHue(`hsl(${hues.negative}, 91%, 18%)`),
    red_950: changeHue(`hsl(${hues.negative}, 91%, 10%)`),
    red_975: changeHue(`hsl(${hues.negative}, 91%, 7%)`),
  } as const
  ...
  const dimPalette: Palette = {
    ...
    positive_25: changeHue(`hsl(${hues.positive}, 50%, ${dimScale[1]}%)`),
    positive_50: changeHue(`hsl(${hues.positive}, 60%, ${dimScale[2]}%)`),
    positive_100: changeHue(`hsl(${hues.positive}, 70%, ${dimScale[3]}%)`),
    positive_200: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[4]}%)`),
    positive_300: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[5]}%)`),
    positive_400: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[6]}%)`),
    positive_500: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[7]}%)`),
    positive_600: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[8]}%)`),
    positive_700: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[9]}%)`),
    positive_800: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[10]}%)`),
    positive_900: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[11]}%)`),
    positive_950: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[12]}%)`),
    positive_975: changeHue(`hsl(${hues.positive}, 82%, ${dimScale[13]}%)`),

    negative_25: changeHue(`hsl(${hues.negative}, 70%, ${dimScale[1]}%)`),
    negative_50: changeHue(`hsl(${hues.negative}, 80%, ${dimScale[2]}%)`),
    negative_100: changeHue(`hsl(${hues.negative}, 84%, ${dimScale[3]}%)`),
    negative_200: changeHue(`hsl(${hues.negative}, 88%, ${dimScale[4]}%)`),
    negative_300: changeHue(`hsl(${hues.negative}, 91%, ${dimScale[5]}%)`),
    negative_400: changeHue(`hsl(${hues.negative}, 91%, ${dimScale[6]}%)`),
    negative_500: changeHue(`hsl(${hues.negative}, 91%, ${dimScale[7]}%)`),
    negative_600: changeHue(`hsl(${hues.negative}, 91%, ${dimScale[8]}%)`),
    negative_700: changeHue(`hsl(${hues.negative}, 91%, ${dimScale[9]}%)`),
    negative_800: changeHue(`hsl(${hues.negative}, 91%, ${dimScale[10]}%)`),
    negative_900: changeHue(`hsl(${hues.negative}, 91%, ${dimScale[11]}%)`),
    negative_950: changeHue(`hsl(${hues.negative}, 91%, ${dimScale[12]}%)`),
    negative_975: changeHue(`hsl(${hues.negative}, 91%, ${dimScale[13]}%)`),
  } as const
  ...
  const dim: Theme = {
    ...
    atoms: {
      ...
      shadow_sm: {
        ...atoms.shadow_sm,
        shadowOpacity: 0.7,
        shadowColor: changeHue(`hsl(${hues.primary}, 28%, 6%)`),
      },
      shadow_md: {
        ...atoms.shadow_md,
        shadowOpacity: 0.7,
